...
//                okhttp3.internal.Platform.get().log(Platform.INFO,message,null);
                Log.i("HttpLoggingInterceptor", message);
//                java.util.logging.Logger.getLogger("http").log(java.util.logging.Level.ALL, message);
            }
        };
    }
    ...
    public okhttp3.Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        logger.log("<-- " + response.request().url().toString() + "\n" + protocol(response.protocol()) + ' ' + response.code() + ' '
