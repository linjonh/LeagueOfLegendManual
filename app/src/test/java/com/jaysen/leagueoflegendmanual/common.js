var gets = {
    ...
    JNav = function() {
        ...
        if (pageType == 0) {
            $('#J_play').on('click', function() {
                ...
                pgvSendClick({ hottag: 'main.header.popup.video' })
            });
        } else {
            //$('.top-act-video,.top-big-video').hide();
            $('.header').addClass('inner-page-header');
        }
    ...
    Jweixin = function() {
        g("topWeixin").style.display = "block";
        move("topWeixin", 1, -95, "left");
        g("topClose").onclick = function() {
            g("topWeixin").style.display = "none";
        }
    };
milo.ready(function() {
...
/*  |xGv00|702ad633a7c1400f3fcc461e25838926 */
